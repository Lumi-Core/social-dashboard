...
const Tracking = {
    ...
    /**
     * Load tracking when page becomes active
     */
    onPageActive() {
        if (!this.initialized) {
            this.init();
     ...
     */
    bindEvents() {
        on('refreshTracking', 'click', () => this.loadTracking());
    ...
    /**
     * View metrics for a specific post
     */
    async viewMetrics(mediaId) {
        ...
        try {
            ...
            // Navigate to metrics page and display specific post
